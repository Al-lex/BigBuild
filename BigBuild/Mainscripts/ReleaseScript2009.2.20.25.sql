/*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
/*%%%%%%%%%%%%%%%%%%%%%%%% Дата формирования: 12.12.2014 13:13 %%%%%%%%%%%%%%%%%%%%%%%%*/
/*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
...
BEGIN TRY
	DECLARE @PrevVersion nvarchar(128) = '9.2.20.24'
	DECLARE @CurrentVersion nvarchar(128) = (SELECT TOP 1 ST_VERSION FROM SETTING)
	DECLARE @NewVersionFull nvarchar(128) = '9.2.20.25'
...
-- =====================   Обновление версии БД. 9.2.20.25 - номер версии, 2014-12-12 - дата версии ===================== 
BEGIN TRY
	DECLARE @SUSER_NAME nvarchar(128) = (SELECT SUSER_NAME())
	DECLARE @HOST_NAME nvarchar(128) = (SELECT HOST_NAME())	

	UPDATE [dbo].[SETTING] 
	SET st_version = '9.2.20.25', st_moduledate = convert(datetime, '2014-12-12', 120),  st_financeversion = '9.2.20.25', st_financedate = convert(datetime, '2014-12-12', 120)
END TRY
BEGIN CATCH
...
BEGIN TRY	
	...
	SET SS_ParmValue='2014-12-12' WHERE SS_ParmName='SYSScriptDate'
END TRY
BEGIN CATCH
...
INSERT INTO ScriptsSetupLogs(RC_Creator, RC_Text, RC_Status, RC_Computer) VALUES(SUSER_NAME(), 'Выполнение релизного скрипта завершено. Версия релиза: 9.2.20.25. Дата релиза: 2014-12-12', 'SCRIPTTIMELINE', HOST_NAME())
GO